                                    ...
                                    <div class="col-md-3">
                                        <ul id="top-tabbar-vertical" class="p-0">
                                            <li class="active step1" id="personal">
                                                <a href="javascript:void();">
                                                    <i
                                                        class="ri-lock-unlock-line bg-soft-primary text-primary"></i><span>Personal</span>
                                                </a>
                                            </li>
                                            <li id="contact" class="step2">
                                                <a href="javascript:void();">
                                                    <i
                                                        class="ri-user-fill bg-soft-danger text-danger"></i><span>Contact</span>
                                                </a>
                                            </li>
                                            <li id="official" class="step3">
                                                <a href="javascript:void();">
                                                    <i
                                                        class="ri-camera-fill bg-soft-success text-success"></i><span>Official</span>
                                                </a>
                                            </li>
                                            <li id="payment" class="step4">
                                                <a href="javascript:void();">
                                                    <i
                                                        class="ri-check-fill bg-soft-warning text-warning"></i><span>Payment</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            <fieldset>
                                                <div class="form-card text-left">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="email">Email Id:
                                                                    *</label>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="ccno">Contact
                                                                    Number: *</label>
                                                                <input type="text" class="form-control"
                                                                    id="ccno" name="ccno"
                                            ...
                                            <fieldset>
                                                <div class="form-card text-left">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="empid">Employee Id:
                                                                    *</label>
                                                                <input type="email" class="form-control"
                                                                    id="empid" name="empid"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="desg">Designation:
                                                                    *</label>
                                                                <input type="text" class="form-control"
                                                                    id="desg" name="desg"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="accname">Departmrnt
                                                                    Name: *</label>
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="workhour">Working Hour:
                                                                    *</label>
                                                                <input type="text" class="form-control"
                                            ...
                                            <fieldset>
                                                <div class="form-card text-left">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="panno">Pan No:
                                                                    *</label>
                                                                <input type="text" class="form-control"
                                                                    id="panno" name="panno"
                                                                    placeholder="Pan No." />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="accno">Account No:
                                                                    *</label>
                                                                <input type="text" class="form-control"
                                                                    id="accno" name="accno"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="holname">Account
                                                                    Holder Name: *</label>
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="ifsc">IFSC Code:
                                                                    *</label>
                                                                <input type="text" class="form-control"
                                                                    id="ifsc" name="ifsc"
