                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap">
                            ...
                            <div class="group-member d-flex align-items-center  mt-md-0 mt-2">
                                <div class="iq-media-group me-3">
                                    ...
                                    <a href="#" class="iq-media">
                                        <img class="img-fluid avatar-40 rounded-circle"
                                            src="../assets/images/user/11.jpg" alt="">
                                    </a>
                                    <a href="#" class="iq-media">
                                        <img class="img-fluid avatar-40 rounded-circle"
                                            src="../assets/images/user/12.jpg" alt="">
                                    </a>
                                </div>
                        ...
                        <div id="post-modal-data" class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ul class=" post-opt-block d-flex list-inline m-0 p-0 flex-wrap">
                                    ...
                                    <li class="bg-soft-primary rounded p-2 pointer d-flex align-items-center me-3"><img
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="post-item">
                                    ...
                                    <div class="user-post">
                                        <a href="javascript:void();"><img src="../assets/images/page-img/52.jpg"
                                ...
                                <div class="post-item">
                                    ...
                                    <div class="user-post">
                                        <a href="javascript:void();"><img src="../assets/images/page-img/60.jpg"
                                                alt="post-image" class="img-fluid w-100" /></a>
                                    </div>
                                    <div class="comment-area mt-3">
                                        <div class="d-flex justify-content-between align-items-center flex-wrap">
